<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Staff.aspx.cs" Inherits="OnlineStoreApp.Pages.Pages_Staff" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="panel">
                ...
                <asp:GridView ID="gvStaff" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                    <AlternatingRowStyle BackColor="White" />
                    <Columns>
                        <asp:BoundField DataField="Username" HeaderText="Username" />
